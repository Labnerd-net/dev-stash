...
- `feature-history.md` - List of all added features and dates
- `features/` - Feature plan files used with the `/feature plan` command
...
- `specs/` - Feature spec files used with the `/feature spec` command